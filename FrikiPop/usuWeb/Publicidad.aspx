...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section id="modPublicidad">
            ...
            <asp:TextBox runat="server" id="id_p" name="id_p" placeholder="ID"/>
            ...
            <asp:TextBox runat="server" id="id_e" name="id_e" placeholder="ID"/>
            ...
            <asp:TextBox runat="server" id="link_e" name="link_e" placeholder="Link"/>
            ...
            <asp:TextBox runat="server" id="imagen" name="imagen" placeholder="URL"/>
